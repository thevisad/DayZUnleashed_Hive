...
public:
	...
	Sqf::Value fetchPlayerVariable( string playerID, string variableName ) override;
	...
	bool updatePlayerVariables( string playerId, string variableName, string variableValue ) override;
